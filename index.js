...
app.get('/recipes/new', middlewares.auth(false), controllers.recipesController.createRecipePage);
app.post('/recipes/new', middlewares.auth(false), controllers.recipesController.createRecipe);
